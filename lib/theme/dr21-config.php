...
$opt_name = 'dr21-config-data';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__('DR21', 'nmbet'),

	// The text to appear on the page title.
	'page_title'                => esc_html__('DR21', 'nmbet'),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__('General', 'nmbet'),
		'id'               => 'general',
...
require_once get_template_directory() . '/lib/theme/redux/general.php';

//Home
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__('Home', 'nmbet'),
		'id'               => 'home',
...
require_once get_template_directory() . '/lib/theme/redux/footer.php';
