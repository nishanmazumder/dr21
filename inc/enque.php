...
function nmbet_scripts() {
	...
	wp_enqueue_script( 'nm-Jquery-1', get_template_directory_uri() . '/assets/js/jquery-1.11.3.min.js');
    wp_enqueue_script( 'nm-bootstrap', get_template_directory_uri() . '/assets/js/functions.js');
    wp_enqueue_script( 'nm-smooth', get_template_directory_uri() . '/assets/js/bootstrap.min.js');
    wp_enqueue_script( 'nm-aos', get_template_directory_uri() . '/assets/js/main.js');
}
